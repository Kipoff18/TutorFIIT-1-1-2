...
namespace MathTutor
{
    public class FormulaSimulator
    {
        ...
        public Dictionary<string, List<Formula>> FormulaBank { get; set; }
        public int RightAnswers { get; set; }
        public Dictionary<string, List<Formula>> WrongAnswers { get; set; }
        ...
        /// <returns></returns>
        public static string[] ReadingAndParsingFile(string bank)
        {
        ...
        /// <returns></returns>
        public static string SelectionOfTopic(string text)
        {
        ...
        /// <param name="text">Данная строка</param>
        /// <returns></returns>
        public static string SelectionOfFormulas(string text)
        {
            var s = Regex.Split(text, @"\|");
            string formula = s[1];
        ...
        /// <param name="text">Данная строка</param>
        /// <returns></returns>
        public static string SelectionOfNameFormulas(string text)
        {
            var s = Regex.Split(text, @"\|");
        ...
        /// </summary>
        public static void ChoosingTopics()
        {
        ...
        /// <returns></returns>
        public static string[] UserChoiceOfTopic(int arraySize)
        {
            string playerAnswer;
        ...
        /// <param name="arraySize"></param>
        /// <returns></returns>
        public static string UserChoiceOfTopicForStatic()
        {
            string playerAnswer;
            string result;
            bool ValidValues = false;
        ...
        /// </summary>
        /// <returns></returns>
        public static string UserChoiceOfCountTopic()
        {
            string playerAnswer;
            string result;
            bool ValidValues = false;
        ...
        /// </summary>
        /// <returns></returns>
        public static int UserChoiceOfCountTreins(int maxTreinCount)
        {
            int playerAnswer;
            int result;
            bool ValidValues = false;
        ...
        /// </summary>
        public void AddingToTheStatisticsFile()
        {
            var treinNumber = 0;
            try
            {
        ...
        public void PrintStatistic(string topicForStatic, int countOfTreinsStatic, int maxTreinsCount, string[] statisticFile)
        {
